namespace TASI
{
    internal class Global
    {
        ...
        public static void InitInternalNamespaces()
        {
            ...
            new Function("WriteLine", VarConstruct.VarType.@void, Namespaces.Last(), new List<List<VarConstruct>> {
            ...
            new Function("Write", VarConstruct.VarType.@void, Namespaces.Last(), new List<List<VarConstruct>> {
                new List<VarConstruct> { new(VarConstruct.VarType.@string, "text")}
            }, new());
            new Function("ReadLine", VarConstruct.VarType.@string, Namespaces.Last(), new List<List<VarConstruct>> {
                new List<VarConstruct> { new(VarConstruct.VarType.@bool, "showTextWhenTyping")},
                new List<VarConstruct> {}
            }, new());
            new Function("Clear", VarConstruct.VarType.@void, Namespaces.Last(), new List<List<VarConstruct>> {
                new List<VarConstruct> {}
            }, new());

            Namespaces.Add(new NamespaceInfo(NamespaceInfo.NamespaceIntend.@internal, "Program"));
            allLoadedFiles.Add("*internal");
            new Function("Pause", VarConstruct.VarType.@void, Namespaces.Last(), new List<List<VarConstruct>> {
                new List<VarConstruct> {},
                new List<VarConstruct> {new(VarConstruct.VarType.@bool, "showPausedMessage")}
            }, new());
            new Function("Exit", VarConstruct.VarType.@void, Namespaces.Last(), new List<List<VarConstruct>> {
                new List<VarConstruct> {}
            }, new());

            Namespaces.Add(new NamespaceInfo(NamespaceInfo.NamespaceIntend.@internal, "Inf"));
            allLoadedFiles.Add("*internal");
            new Function("DefVar", VarConstruct.VarType.@void, Namespaces.Last(), new List<List<VarConstruct>> {
            ...
            allLoadedFiles.Add("*internal");
            new Function("ToNum", VarConstruct.VarType.num, Namespaces.Last(), new List<List<VarConstruct>> {
            ...
            allLoadedFiles.Add("*internal");
            new Function("AskQuestion", VarConstruct.VarType.@string, Namespaces.Last(), new List<List<VarConstruct>> {
            ...
            allLoadedFiles.Add("*internal");
            new Function("ToLower", VarConstruct.VarType.@string, Namespaces.Last(), new List<List<VarConstruct>> {
