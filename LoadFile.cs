    ...
    internal class LoadFile
    {
        public static List<Command> ByPath(string location, Global global, bool autoAddToGlobal = true)
        {
            ...
            if (!File.Exists(location))
            {
                ...
                throw new CodeSyntaxException("The entered file doesn't exist.");
            }
        ...
        public static Value? RunCode(string code, Global? global = null)
        {
            ...
            foreach (Command command in codeHeaderInformation.Item1)
            {
                ...
                if (command.commandType == Command.CommandTypes.FunctionCall) command.functionCall.SearchCallNameObject(codeHeaderInformation.Item2, global);
