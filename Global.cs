namespace TASI
{
    ...
    public class Global
    {
        ...
        public Global(string currentFile = "")
        {
            ...
            new Function("Create", VarConstruct.VarType.@int, Namespaces[8], new List<List<VarConstruct>> {
                new List<VarConstruct> {},
                new List<VarConstruct> {new(VarConstruct.VarType.@int, "min")},
                new List<VarConstruct> {new(VarConstruct.VarType.@int, "min"), new(VarConstruct.VarType.@int, "max")}
            }, new(), this);
            ...
            new Function("Execute", VarConstruct.VarType.@string, Namespaces[9], new List<List<VarConstruct>> {
                new List<VarConstruct> {new(VarConstruct.VarType.@string, "cmd")},
            }, new(), this);
            new Function("Run", VarConstruct.VarType.@void, Namespaces[9], new List<List<VarConstruct>> {
                new List<VarConstruct> {new(VarConstruct.VarType.@string, "cmd")},
            }, new(), this);
            Namespaces.Add(new NamespaceInfo(NamespaceInfo.NamespaceIntend.@internal, "String", true));
            AllLoadedFiles.Add("*internal");
            new Function("Replace", VarConstruct.VarType.@string, Namespaces[10], new List<List<VarConstruct>> {
